...
config.problemStomachUlcer = { 
    '1': 'GMPFLD(.01)="521774^R69."',
    '2': 'GMPFLD(.03)="0^"',
    '3': 'GMPFLD(.05)="^Stomach ulcer"',
    '4': 'GMPFLD(.08)="3170316"',
    '5': 'GMPFLD(.12)="A^ACTIVE"',
    '6': 'GMPFLD(.13)="^"',
    '7': 'GMPFLD(1.01)="7805405^Stomach ulcer"',
    '8': 'GMPFLD(1.02)="P"',
    ...
    '23': 'GMPFLD(1.17)="0^NO"',
    '24': 'GMPFLD(1.18)="0^NO"',
    '25': 'GMPFLD(80001)="397825006^397825006"',
    '26': 'GMPFLD(80002)="1785985013^1785985013"',
    '27': 'GMPFLD(80101)="^"',
    '28': 'GMPFLD(80102)="^"',
